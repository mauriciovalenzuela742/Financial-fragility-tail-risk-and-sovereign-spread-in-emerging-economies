...
class SFC:
    ...
    def search(self, year, month, reporttype_value):
        # PASO 1: Simular el cambio de dropdown "reportType" que encontraste en el tráfico.
        # Esto le avisa al servidor JSF que prepare los componentes de Año/Mes correctos.
        trigger_data = {
            "javax.faces.partial.ajax": "true",
            "javax.faces.source": "reportType",
            "javax.faces.partial.execute": "reportType",
            "javax.faces.partial.render": "reportType resultForm interBlock endBlock",
        ...
        # Enviamos el trigger y actualizamos el ViewState con la respuesta
        self._post(trigger_data)

        # PASO 2: Ahora sí, el POST de búsqueda real usando los nuevos IDs que descubrimos:
        # 'cutOffYearClosed_input' y 'cutOffMonthClosed_input'
        search_data = {
            "javax.faces.partial.ajax": "true",
            ...
            "entityTypeCode_input": "", "entityTypeCode_hinput": "",
            "reportType_focus": "", "reportType_input": reporttype_value,
            "cutOffYearClosed_focus": "", "cutOffYearClosed_input": str(year),
            "cutOffMonthClosed_focus": "", "cutOffMonthClosed_input": str(month),
            "j_idt19_collapsed": "false",
            "javax.faces.ViewState": self.vs or "",
        }
        return self._post(search_data)
