...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Provee evidencia con un \textit{pipeline} reproducible de extracción de balances bancarios y de estimación de GaR pseudo–tiempo real (ventana expansiva), sobre un único panel de economías emergentes construido íntegramente con datos de Bloomberg, y delimita con precisión —mediante una batería de robustez y de identificación causal— dónde el mecanismo está establecido y dónde constituye todavía una hipótesis abierta.
    \end{enumerate}
    ...
    \item \textbf{Hoja de ruta.} La Sección 2 desarrolla el marco teórico. La Sección 3 sintetiza el estado del arte. La Sección 4 detalla la metodología de construcción de JLoss y GaR y la estrategia econométrica. La Sección 5 describe el panel de datos y su cobertura. La Sección 6 reporta los resultados, incluida la robustez temporal y la identificación causal. La Sección 7 discute las implicancias y concluye. El Anexo~\ref{chap:anexoB} tabula la procedencia de todas las series.
\end{itemize}
