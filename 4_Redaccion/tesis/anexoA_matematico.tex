...
\[
\boxed{\ \frac{\partial^2 \Spread}{\partial \JLoss\,\partial \GaR}=LGD\,\frac{B_J}{Y}\,f_\eta'(DFL)\,\frac{\partial DFL}{\partial \GaR}\;<\;0.\ }
\]
\end{proposition}
\begin{proof}
...
Sea $C(H)\equiv\dfrac{\partial^2 \Spread}{\partial \JLoss\,\partial \GaR}<0$. Bajo los Supuestos~\ref{as:B-A}--\ref{as:g-A} y la condición de cola profunda $f_\eta''(DFL)\ge0$,
\[
\beta_4=\frac{\partial C}{\partial H}=\frac{\partial^3 \Spread}{\partial \JLoss\,\partial \GaR\,\partial H}<0,
\]
...
\beta_1=\frac{\partial\Spread}{\partial\JLoss}>0,\qquad
\beta_2=\frac{\partial\Spread}{\partial\GaR}<0,\\[2pt]
\beta_3=\frac{\partial^2\Spread}{\partial\JLoss\partial\GaR}<0\ (\text{Prop.~\ref{prop:cross-A}}),\qquad
\beta_4=\frac{\partial^3\Spread}{\partial\JLoss\partial\GaR\partial\HHI}<0\ (\text{Prop.~\ref{prop:amp-A}}).
\end{gather*}
