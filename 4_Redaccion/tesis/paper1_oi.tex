...
\]
es decir, fragilidad sistémica y riesgo a la baja son complementarios: el efecto marginal de $\JLoss$ sobre el spread \emph{crece} cuando $\GaR$ cae (crecimiento de cola más adverso). Además la interacción se vuelve más negativa con la concentración, $\partial^3\Spread/(\partial\JLoss\,\partial \GaR\,\partial H)<0$. (La demostración detallada paso a paso está en el Anexo~\ref{chap:anexoA}.)
\end{proposition}
