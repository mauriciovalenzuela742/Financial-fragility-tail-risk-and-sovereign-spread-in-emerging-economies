...
clear all
clc
%Posicion	LGD	DefProb	Rho 1	Rho 2	Rho 3	Rho 4	Exposicion	Sev
%date	st_liab	lt_liab	st_asset	lt_asset	equity_value equity_volume
...
[pdcountry el ul]=countryPDS(data, num_order, num_factors, loss_inf, loss_sup, num_steps, percentil);
