...
Cambios respecto a phase2_gar_panel_all.py (OUT_TAG="all15"):
  - SOURCE_FILE -> GaR_panel_all18_noCDIFF.xlsx (no toca GaR_panel_all.xlsx original).
...
SOURCE_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "GaR_panel_all18_noCDIFF.xlsx")
SHEET = "Panel"
DEPENDENT = "g_GDP"
